namespace NavisElectronics.TechProcess
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Выберите, для какого типа изделия начать расчет";
            // 
            // listBox1
            // 
            this.listBox1.FormattingEnabled = true;
            this.listBox1.Items.AddRange(new object[] {
            "Прямоугольное бумажное изделие",
            "Шильд из ленты",
            "Плата печатная"});
            ...
            // button1
            // 
            this.button1.Location = new System.Drawing.Point(283, 38);
            ...
            this.Name = "MainForm";
            this.Text = "Расчет количества материала на единицу изделия";
